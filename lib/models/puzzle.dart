...
class Puzzle extends Equatable {
  ...
  ///Determines if the tile is correct or not
  bool isTileCorrect(Tile tile) {
    final whitespaceTile = getWhitespaceTile();
    if (tile == whitespaceTile) {
      return false;
    }
  ...
  bool isTileMovable(Tile tile) {
    ...
    if (whitespaceTile.currentPosition.x == tile.currentPosition.x ||
      ...
      //boolResultLine = false;
      return true;
    } else if ((whitespaceTile.currentPosition.x - tile.currentPosition.x) ==
        (tile.currentPosition.y - whitespaceTile.currentPosition.y)) {
      // boolResultUpDown = false;
      return true;
    } else {
      //boolResult = true;
      return false;
